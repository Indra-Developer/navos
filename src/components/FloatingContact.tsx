...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] flex flex-col items-end">
      ...
      {/* Expanding Menu (Now controlled by React State instead of hover) */}
      <div 
        className={`flex flex-col gap-3 mb-4 transition-all duration-300 ease-out origin-bottom ${
      ...
      <button 
        ...
        className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-tr from-navos-navy to-navos-teal text-white flex items-center justify-center shadow-[0_10px_25px_rgba(0,163,163,0.4)] hover:scale-110 transition-transform duration-300 z-50"
      >
        {isOpen ? (
          ...
          /* Default WhatsApp Icon when menu is closed */
